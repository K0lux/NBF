  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        position === "popper" &&
          "data-[state=open]:split-in-from-top-2 data-[state=closed]:split-out-to-top-2 data-[state=bottom]:translate-y-1 data-[state=left]:-translate-x-1 data-[state=right]:translate-x-1 data-[state=top]:-translate-y-1",
        className
      )}
      position={position}
      {...props}
